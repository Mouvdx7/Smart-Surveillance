  ...
  head: () => ({
    meta: [
      ...
      { title: "Smart Surveillance — Votre quartier, sous votre regard" },
      {
        name: "description",
        content:
          "Surveillez vos caméras à distance, recevez des alertes en temps réel et protégez votre quartier. Simple, rapide, et conçu pour tous.",
      },
      { name: "author", content: "Smart Surveillance" },
      { property: "og:title", content: "Smart Surveillance" },
      {
